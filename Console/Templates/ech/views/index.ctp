...
<div class="<?php echo $pluralVar; ?> index">
	...
	echo "\t<tr>\n";
		...
		echo "\t\t\t<?php echo \$this->Html->link(__('View'), array('action' => 'view', \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?>\n";
	 	...
	 	echo "\t\t\t<?php echo \$this->Form->postLink(__('Delete'), array('action' => 'delete', \${$singularVar}['{$modelClass}']['{$primaryKey}']), null, __('{$deleteMessage}', \${$singularVar}['{$modelClass}']['{$deleteModelProperty}'])); ?>\n";
		echo "\t\t</td>\n";
	echo "\t</tr>\n";
